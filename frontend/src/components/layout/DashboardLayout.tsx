...
const NAV: Record<Role, NavItem[]> = {
  ...
  HR: [
    ...
    { to: "/hr/registrations", label: "Registrations" },
    ...
    { to: "/hr/profile-changes", label: "Profile changes" },
  ],
  TRAINER: [
    ...
    { to: "/trainer/profile-changes", label: "Profile changes" },
  ],
  INTERN: [
    ...
    { to: "/intern/profile", label: "Profile" },
  ],
  COLLEGE: [
    ...
    { to: "/college/profile-changes", label: "My change requests" },
  ],
};
